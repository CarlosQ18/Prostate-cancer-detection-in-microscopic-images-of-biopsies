...
Modelo = model.load_model('C:\Users\Carlos F. Quintero\Desktop\Test Definitivo\EfficientNetB0\EfficientNetB0');

PathTissueClassification = string(pwd) + '\'+'Tissue_Classification_EfficientNetB0.txt'; 
