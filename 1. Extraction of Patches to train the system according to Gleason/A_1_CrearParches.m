...
for i = 0:5
   ...
   for j = 1:numel(Grado_folder_names)
      ...
      if ~exist(original_folder, 'dir')
          ...
          masktissue_name = tissue_names{2};

          rgbtissue = imread(fullfile(ID_Image_name_path, Rgbtissue_name));
          masktissue = imread(fullfile(ID_Image_name_path, masktissue_name));
          masktissue = masktissue(:,:,1);
          Patch_size = 512;

          A_2_ImagePatching(rgbtissue,masktissue,ID_Image_name,original_folder,Patch_size);
      end
