...
% Inverse difference (INV) is invdf [3]     (out.invdf)
...
out.invdf = zeros(1,size_glcm_3); % Homogeneity: matlab
...
%out.invdc = zeros(1,size_glcm_3);% Inverse difference (INV) is invdf [3]
...
for k = 1:size_glcm_3 % number glcms
    ...
    for i = 1:size_glcm_1
        ...
        for j = 1:size_glcm_2
            ...
            out.invdf(k) = out.invdf(k) + (glcm(i,j,k)/( 1 + abs(i-j) ));
